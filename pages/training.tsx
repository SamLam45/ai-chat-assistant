   ...
   {/* Topbar Start */}
      ...
      <div className="container-fluid bg-breadcrumb">
        <div className="container text-center py-5" style={{ maxWidth: '900px' }}>
          <h3 className="text-primary display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s">服务项目</h3>
    ...
    <div className="pb-5">
      <div className="row g-4 align-items-end">
        <div className="col-xl-8">
          ...
          <h1 className="display-2 mb-0 wow fadeInUp" data-wow-delay="0.3s">服务项目平台</h1>
        </div>
        <div className="col-xl-4 text-xl-end wow fadeInUp" data-wow-delay="0.3s">
          <a className="btn btn-primary rounded-pill text-white py-3 px-5" href="#">查看所有服务</a>
        </div>
      </div>
    </div>
      ...
      {[
        ...
        >
          <div className="training-item bg-white rounded shadow p-4 h-100">
            ...
            <a className="btn btn-primary rounded-pill text-white py-2 px-4" href="#">了解更多</a>
          </div>
        </div>
      ))}
    </div>
...
{/* Training End */}
        ...
        <div className="modal-dialog">
          <div className="modal-content rounded-0">
            <div className="modal-header">
              <h5 className="modal-title" id="exampleModalLabel">视频展示</h5>
      ...
      <div className="container-fluid gallery py-5 bg-white">
        <div className="container py-5">
          <div className="pb-5">
            <h4 className="text-secondary sub-title fw-bold animate__animated animate__fadeInUp" data-wow-delay="0.1s">我们的服务图库</h4>
            <h1 className="display-2 mb-0 animate__animated animate__fadeInUp" data-wow-delay="0.3s">服务项目图库</h1>
          </div>
